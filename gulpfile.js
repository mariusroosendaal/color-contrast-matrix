...
const files = { 
    ...
    figmaDSPath: 'node_modules/figma-plugin-ds/dist/*.css', //path to your CSS/SCSS folder
...
function watchTask(){
    watch([files.scssPath, files.figmaDSPath, files.jsPath, files.tsPath, files.html, files.manifest],
